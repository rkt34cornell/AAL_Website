            ...
            <div class="-mx-4 flex flex-wrap lg:justify-between">
              <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0">
                  <h2 class="text-secondary mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  ...
                  <div class="mb-8 flex w-full max-w-[370px]">
                    <div class="bg-white text-secondary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
              ...
              <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div class="relative rounded-lg bg-white p-6 shadow-lg sm:p-8">
                  <form>
                    <div class="mb-6">
                      <input
                        type="text"
                    ...
                    <div>
                      <button
                        type="submit"
                        class="bg-secondary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                      >
                        Send Message
                      </button>
                    </div>
