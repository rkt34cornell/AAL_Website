                ...
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-white text-base">(+1) xxx-xxx xxxx</p>
                    </div>
                  </div>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    <div className="bg-white text-secondary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                  ...
                  <form ref={form} onSubmit={handleSubmit(sendEmail)}>
                    <div className="mb-6">
                      <input
                        ...
                        className="text-body-color focus:border-secondary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                        name="from_name"
                        {...register("name", { required: true })}
                      />
                      {errors.name && (
                        <p className="text-[#eed202]">Please enter your name</p>
                      )}
                    </div>
                    <div className="mb-6">
                      <input
                    ...
                    <div>
                      <button
                        type="submit"
                        className="bg-secondary w-full rounded border-white p-3 text-white transition hover:bg-opacity-90"
                      >
                        Send Message
                      </button>
                    </div>
